...
public class SummaryPanel extends JPanel {
    ...
    public SummaryPanel(Standalone parent) {
        ...
        centerPanel.add(Box.createVerticalStrut(25));
        centerPanel.add(createTextPanel("To re-process any skipped lines, (re)start the application and re-select the input data file."));
    ...
    private JPanel buildSummaryPanel(Session session) {
        ...
        constraints.gridx = 0;
        constraints.anchor = GridBagConstraints.EAST;
        summaryPnl.add(Utils.createLabel("number no-result: "), constraints);
        constraints.gridx = 1;
        constraints.anchor = GridBagConstraints.WEST;
