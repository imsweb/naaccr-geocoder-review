...
public class ProcessingPanel extends JPanel {
    ...
    static {
        ...
        penaltyCode2.put(PENALTY_CODE_KEY_NAME, "Street Type");
        ...
        penaltyCode3.put(PENALTY_CODE_KEY_NAME, "Street");
        ...
        penaltyCode4.put(PENALTY_CODE_KEY_NAME, "Zip");
        ...
        penaltyCode5.put(PENALTY_CODE_KEY_NAME, "City");
        ...
        penaltyCode6.put(PENALTY_CODE_KEY_NAME, "City Refs");
        ...
        penaltyCode7.put(PENALTY_CODE_KEY_NAME, "Directonals");
        ...
        penaltyCode8.put(PENALTY_CODE_KEY_NAME, "Qualifiers");
        ...
        penaltyCode9.put(PENALTY_CODE_KEY_NAME, "Distance");
        ...
        penaltyCode10.put(PENALTY_CODE_KEY_NAME, "Outliers %");
        ...
        penaltyCode11.put(PENALTY_CODE_KEY_NAME, "Census Blocks");
        ...
        penaltyCode12.put(PENALTY_CODE_KEY_NAME, "Census Tracts");
        ...
        penaltyCode13.put(PENALTY_CODE_KEY_NAME, "Census Counties");
        ...
        penaltyCode14.put(PENALTY_CODE_KEY_NAME, "Ref Match Count");
    ...
    private JPanel buildNorthPanel(Session session) {
        ...
        _penaltyCodeLbl.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                dialogPnl.add(Utils.createLabel(getPenaltyCodeTranslations(_penaltyCodeLbl.getText())));
    ...
    private String getPenaltyCodeTranslations(String penaltyCode) {
